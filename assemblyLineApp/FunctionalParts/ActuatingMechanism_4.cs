...
public class ActuatingMechanism4: ActuatingMechanismBase,IActuatingMechanism4
{
    ...
    {
        Console.WriteLine();
        Console.WriteLineStyled("   Исполнительный механизм №4",_styleWhite);
