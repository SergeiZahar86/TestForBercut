...
public class ActuatingMechanism1: ActuatingMechanismBase,IActuatingMechanism1
{
    ...
    {
        Console.WriteLine();
        Console.WriteLineStyled("   Исполнительный механизм №1",_styleWhite);
