...
public class ActuatingMechanism3: ActuatingMechanismBase,IActuatingMechanism3
{
    ...
    {
        Console.WriteLine();
        Console.WriteLineStyled("   Исполнительный механизм №3",_styleWhite);
